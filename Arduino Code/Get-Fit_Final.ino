...
BLEService merilecexerciseov("e267751a-ae76-11eb-8529-0242ac130003");
...
void setup()
{
    ...
    BLE.setAdvertisedService(merilecexerciseov);
    ...
    merilecexerciseov.addCharacteristic(exercise); 
    merilecexerciseov.addCharacteristic(start);
    merilecexerciseov.addCharacteristic(pause);



    BLE.addService(merilecexerciseov);
